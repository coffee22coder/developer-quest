...
initIntro(() => {
  showDialog({
    text: 'Привет! Меня зовут Женя. Я хотел сделать портфолио поинтереснее — и слишком увлёкся: контакты и резюме куда-то спрятались в этой комнате. Поможешь найти? Иначе так и не доберусь до собеседования)',
    buttons: [
